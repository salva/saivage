 ...
 *
 * `normalizeTask` and `buildFailureReport` were previously duplicated in
 * coder.ts, researcher.ts, data-agent.ts, and reviewer.ts. They now live here,
 * parameterised by the worker role.
 */
