...
| (f) | Final `npm audit` evidence capture | This plan file only — [saivage/SPEC/2026-05/node24-deps-refresh/F02-node24-deps-refresh/03-plan-r3.md](saivage/SPEC/2026-05/node24-deps-refresh/F02-node24-deps-refresh/03-plan-r3.md) §9 evidence block | T+L+A+F+W | (e) | `git revert <hash>` |
...
- [saivage/SPEC/2026-05/node24-deps-refresh/F02-node24-deps-refresh/03-plan-r3.md](saivage/SPEC/2026-05/node24-deps-refresh/F02-node24-deps-refresh/03-plan-r3.md) — §9 evidence block only.
...
git add SPEC/2026-05/node24-deps-refresh/F02-node24-deps-refresh/03-plan-r3.md
