...
const PROTECTED_DATASETS: RuntimeRagDatasetConfig[] = [
  { id: "knowledge.skills", source: "skill",
    ...
    provider: { kind: "openai", model: "text-embedding-3-small", dim: 1024 },
...
The `provider` shape matches [EmbeddingProviderRef](src/rag/types.ts#L11-L15)
(`{ kind: "openai", model: "text-embedding-3-small", dim: 256 | 512 |
1024 | 1536 }`).
