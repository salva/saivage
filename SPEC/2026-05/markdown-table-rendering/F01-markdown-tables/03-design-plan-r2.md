# F01 — Markdown Table Rendering — Design + Plan r2

> **r2 changes from r1** (per [03-design-plan-review-r1.md](03-design-plan-review-r1.md)):
> 1. Corrected CSS deletion line ranges — `FormattedContent.vue` is L91-L110 (was L93-L112); `ChatWindow.vue` is L535-L554 (was L538-L557).
