# F01 — Markdown Table Rendering — Design + Plan r1
...
- `:deep(.md-h1)`, `:deep(.md-h2)`, `:deep(.md-h3)` —
  [web/src/components/FormattedContent.vue#L93-L95](../../../../web/src/components/FormattedContent.vue#L93-L95).
- `:deep(.md-code)` —
  [web/src/components/FormattedContent.vue#L96](../../../../web/src/components/FormattedContent.vue#L96).
- `:deep(.md-code-block)` and `:deep(.md-code-block code)` —
  [web/src/components/FormattedContent.vue#L97-L98](../../../../web/src/components/FormattedContent.vue#L97-L98).
- `:deep(.md-bullet)` grid rule —
  [web/src/components/FormattedContent.vue#L99-L105](../../../../web/src/components/FormattedContent.vue#L99-L105).
- `:deep(.md-marker)` —
  [web/src/components/FormattedContent.vue#L106-L111](../../../../web/src/components/FormattedContent.vue#L106-L111).
- `:deep(.md-bullet-text)` —
  [web/src/components/FormattedContent.vue#L112](../../../../web/src/components/FormattedContent.vue#L112).
...
[L93-L95](../../../../web/src/components/FormattedContent.vue#L93-L95)):
...
- `.msg.assistant .msg-content :deep(.md-h1|h2|h3)` —
  [web/src/components/ChatWindow.vue#L538-L540](../../../../web/src/components/ChatWindow.vue#L538-L540).
- `.msg.assistant .msg-content :deep(.md-code)` —
  [web/src/components/ChatWindow.vue#L541](../../../../web/src/components/ChatWindow.vue#L541).
- `.msg.assistant .msg-content :deep(.md-code-block)` and
  `:deep(.md-code-block code)` —
  [web/src/components/ChatWindow.vue#L542-L543](../../../../web/src/components/ChatWindow.vue#L542-L543).
- `.msg.assistant .msg-content :deep(.md-bullet)` grid block —
  [web/src/components/ChatWindow.vue#L544-L550](../../../../web/src/components/ChatWindow.vue#L544-L550).
- `:deep(.md-marker)` —
  [web/src/components/ChatWindow.vue#L551-L556](../../../../web/src/components/ChatWindow.vue#L551-L556).
- `:deep(.md-bullet-text)` —
  [web/src/components/ChatWindow.vue#L557](../../../../web/src/components/ChatWindow.vue#L557).

**KEEP, but mutate one declaration**:

- `.msg-content` wrapper block —
  [web/src/components/ChatWindow.vue#L487-L497](../../../../web/src/components/ChatWindow.vue#L487-L497).
  Change `white-space: pre-wrap;`
  ([L495](../../../../web/src/components/ChatWindow.vue#L495)) →
  ...
  / system branches at
  [web/src/components/ChatWindow.vue#L500-L509](../../../../web/src/components/ChatWindow.vue#L500-L509)
...
- `.msg.assistant .msg-content :deep(strong)` and `:deep(em)` —
  [web/src/components/ChatWindow.vue#L536-L537](../../../../web/src/components/ChatWindow.vue#L536-L537).
...
[web/src/components/ChatWindow.vue#L542](../../../../web/src/components/ChatWindow.vue#L542)):
...
4. Edit
   ...
   [L535-L554](../../../../web/src/components/ChatWindow.vue#L535-L554),
   change `white-space: pre-wrap` → `normal` at
   [L495](../../../../web/src/components/ChatWindow.vue#L495), and
