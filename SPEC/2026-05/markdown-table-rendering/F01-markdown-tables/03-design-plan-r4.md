# F01 — Markdown Table Rendering — Design + Plan r4

> **r4 changes from r3** (per [03-design-plan-review-r3.md](03-design-plan-review-r3.md)):
> - Corrected §3b kept `strong`/`em` citation to L533-L534 (was L536-L537).
> - Corrected §3b user/system branches citation to L498-L508 (was L500-L509).
