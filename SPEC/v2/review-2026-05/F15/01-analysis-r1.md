...
- [`router.chat` candidate loop](src/providers/router.ts#L297-L299) — happy path for every agent call.
...
- [`router.callProvider` final retry path](src/providers/router.ts#L639) — wraps the same chat path.
